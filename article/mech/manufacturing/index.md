...
3. エッチング
   - ウェットエッチング
     - 等方的
     - サイドエッチング（まわりこみ）に注意
     - $"Cu" + 2 "FeCl"_3 -> "CuCl"_2 + 2 "FeCl"_2$
     - $"Si" + "KOH" -> "K"_2 "SiO"_3 + "H"_2$
   - リフトオフ
   - ドライエッチング
...
励起された電子はある時間（蛍光寿命）経つと、基底状態にもどり、このときに光を放出する（自然放出）。光の波長は $Delta E = h(c)/(lambda)$ 。自然放出された光が、同じ励起状態にある電子にあたると、まったく同じ状態の（周波数はもちろん、位相、偏光も同じ）光を放出する（誘導放出）。
...
$z$ ~ $z+d z$ の領域で、誘導放出と吸光する光子数の関係は、

$$
phi(z+d z) = phi(z) + N_2Wdz - N_1Wdz
$$

$$
(dif phi)/(dif z) = (N_2-N_1) sigma phi
$$
