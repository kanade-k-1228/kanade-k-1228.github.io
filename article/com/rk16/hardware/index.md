...
$$
A+overline(B)+1=A-B+10000 >= 10000 => A >= B
$$
...
| OUT           | Deode                                                                   |
| :------------ | :---------------------------------------------------------------------- |
| S~3~          | $overline(C_3)dot.op(overline(C_0)+overline(C_2)dot.op C_1)$            |
| S~2~          | $C_3+C_1dot.op C_0$                                                     |
| S~1~          | $C_3+C_2$                                                               |
| S~0~          | $overline(C_3+C_1+C_0)$                                                 |
| M             | $overline(C_3)dot.op(overline(C_1)dot.op C_0 + C_2dot.c overline(C_0))$ |
| C_SEL         | $C_2$                                                                   |
| C_USE         | $overline(C_3 dot.op C_1 dot.op C_0)$                                   |
| COMP_US       | $C_3 dot.op C_1 dot.op C_0$                                             |
| SR_US         | $C_3$                                                                   |
| SR_SEL        | $C_2$                                                                   |
| EQ_NEQ        | $C_3$                                                                   |
| BOOL_SEL      | $C_2$                                                                   |
| OUT_SEL_ALU   | $overline(C_3)$                                                         |
| OUT_SEL_BOOL  | $C_3dot.c overline(C_2)$                                                |
| OUT_SEL_SHIFT | $C_3dot.op C_2$                                                         |
...
$$
"MUX" = A dot.op S + B dot.op overline(S) = overline(overline(A dot.op S) dot.c overline(A dot.c overline(S)))
$$
