...
$$
R(T) = R_0 exp l[ B l( (1)/(T) - (1)/(T_0) r) r]
$$
...
$$
R(T) = R_P l((V_0)/(V(T))-1r)
$$

$$
(1)/(T) = (1)/(B) ln lr(((R(T))/(R_0)r)) + (1)/(T_0)
$$

$$
T = l{(1)/(B) lnl[(R_P)/(R_0)l((V_0)/(V(T))-1r)r] + (1)/(T_0)r}^(-1)
$$

1. ADC の値$V_A$から

$$
X = (47)/(10000)(1024-V_(A))/(V_(A))
$$
...
対数関数は $Xtilde 0.01$ のまわりで近似したものを使う
