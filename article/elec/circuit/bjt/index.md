...
$$
I_E = I_B + I_C approx I_C quad (I_B << I_C)
$$
...
よって、NPN が ON になる条件は、$V_("IN")+V_("BE")>V_("BE") therefore V_("IN")>0$。PNP が ON になる条件は、$V_("IN")-V_("BE")<V_("BE") therefore V_("IN")<0$。これで、入出力のグラフが綺麗な直線になった。
